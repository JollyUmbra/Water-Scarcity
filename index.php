...
<div class="content-container">
	...
	<div class="section-left">
		<img class="index-image" src="images/bucket.png" alt="Spilled bucket">
	...
	<div class="section-right">
		...
		<img class="index-image" src="images/bottle.png" alt="Water bottle">
	</div>
	...
	<div class="section-right">
		...
		<img class="index-image" src="images/no-water.png" alt="Water drop with giant red cross">
	</div>

	<div class="section-left">
		<img class="index-image" src="images/faucet.png" alt="Leaky faucet">
...
<div id="load-modal-continer">
  ...
  <div id="load-modal">
    ...
    <h2 style="font-family: 'Oswald', sans-serif; margin-top: 80px;">Welcome! Come learn about water scarcity!</h2>
    <p style="font-family: 'Quattrocento Sans', sans-serif; margin: 0 50px 0;">This site serves to educate people about the very big problem of water scarcity all around the world. It also serves as a way to interact with an art installation in a gallery. By visiting the website, you help slow the flow of water from a leaking water bucket. When the page loads, an audio response is played as well using your ip address to apply audio effects to a recording of flowing water. If you do not move the mouse for 15 seconds after closing this window, the page will refresh for the next viewer and on load the audio response will be played and the water flow will be slowed. By learning about the cause you can contribute to this art piece, and if you really feel committed, you can sign the roster to commit to water conservation. On the page after signing up, you can view a PDF with some tips to how you can help!</p>
